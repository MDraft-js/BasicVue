<template>
  <div class="product-list">
    ...
    <ul class="list-default flex">
      <li v-for="(product, index) in products" :key="index"><ProductCard :title="product.title" :price="product.price" :imgUrl="product.imgUrl" :count="product.count" @addToBasketEmit="addToBasket(index)" /></li>
    </ul>
  </div>
</template>
